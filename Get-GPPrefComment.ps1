...
.EXAMPLE
  Get-GPPPrefComment -GPOName "GPO1" -Machine -ComputerSection Folders
.EXAMPLE
  Get-GPPPrefComment -GPOName "GPO1" -Machine -ComputerSection Folders -ItemName 'MyFolder'
.EXAMPLE
  Get-GPPPrefComment -GPOName "GPO1" -User -UserSection Files
.EXAMPLE
  Get-GPPPrefComment -GPOName "GPO1" -User -UserSection Files -ItemName 'TestFile.txt'
.NOTES
