...
$searchScopes = (
    ...
    "HKCU:\SOFTWARE\Wow6432Node\Microsfot\Office\Excel\Addins",
    "HKCU:\SOFTWARE\Wow6432Node\Microsfot\Office\OneNote\Addins",
    "HKCU:\SOFTWARE\Wow6432Node\Microsoft\Office\Outlook\Addins",
    "HKCU:\SOFTWARE\Wow6432Node\Microsfot\Office\PowerPoint\Addins",
    "HKCU:\SOFTWARE\Wow6432Node\Microsfot\Office\Word\Addins",
